...
int main()
{
	...
	ni::Float4x4 projMtx;
	projMtx.perspective(ni::toRad(60.0f), ni::getViewAspectRatio(), 0.1f, 1000.0f);
	...
	outputTexture->resource.apiResource->SetName(L"outputTexture");
	resultTAA->resource.apiResource->SetName(L"resultTAA");
